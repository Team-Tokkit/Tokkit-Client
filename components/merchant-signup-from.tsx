  ...
  return (
    <div>
      <div className="flex items-center mb-4 bg-[#F5F5F5]  p-3 rounded-lg">
        ...
        <span className="text-sm font-medium text-[#1A1A1A] ">가맹점주 회원가입</span>
      </div>

      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="space-y-2">
          <Label htmlFor="business-number" className="text-[#444444]  text-sm font-medium">
            사업자 등록번호
          </Label>
          <Input
            id="business-number"
        ...
        <div className="space-y-2">
          <Label htmlFor="store-name" className="text-[#444444]  text-sm font-medium">
            상호명
          </Label>
          <Input
            id="store-name"
        ...
        <div className="space-y-2">
          <Label htmlFor="merchant-email" className="text-[#444444]  text-sm font-medium">
            이메일
          </Label>
          <Input
            id="merchant-email"
        ...
        <div className="space-y-2">
          <Label htmlFor="merchant-confirm-password" className="text-[#444444]  text-sm font-medium">
            비밀번호 확인
          </Label>
          <div className="relative">
            <Input
        ...
        <div className="space-y-2 pt-1">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="merchant-terms" className="text-xs font-normal text-[#666666] ">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              className="border-[#CCCCCC]  data-[state=checked]:bg-[#FFB020]  data-[state=checked]:border-[#FFB020] "
            />
            <Label htmlFor="merchant-marketing" className="text-xs font-normal text-[#666666] ">
        ...
        <Button
          type="submit"
          className="w-full h-10 bg-[#FFB020] hover:bg-[#FF9500]   text-white  font-medium rounded-lg shadow-md shadow-[#FFB020]/20  mt-2"
          disabled={loading}
        >
