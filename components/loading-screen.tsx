...
export default function LoadingScreen({ message = "로딩 중..." }: LoadingScreenProps) {
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#121212] flex flex-col items-center justify-center p-6">
      ...
      >
        <motion.div
          className="absolute inset-0 border-4 border-[#FFB020] dark:border-[#FFD485] rounded-full border-t-transparent"
          animate={{ rotate: 360 }}
      ...
      <motion.p
        className="text-[#666666] dark:text-[#BBBBBB] text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
