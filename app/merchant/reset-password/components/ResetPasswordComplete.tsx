...
export default function ResetPasswordComplete({ email, onComplete }: ResetPasswordCompleteProps) {
    return (
        <div className="text-center">
            ...
            <h2 className="text-xl font-bold mb-2 text-[#1A1A1A] dark:text-white">비밀번호 초기화 완료</h2>
            <p className="text-[#666666] dark:text-[#BBBBBB] mb-6">
            ...
            <Button
                className="w-full h-12 bg-[#FFB020] hover:bg-[#FF9500] text-white dark:text-[#1A1A1A] font-medium rounded-xl shadow-md shadow-[#FFB020]/20 mt-6"
                onClick={onComplete}
            >
                로그인 화면으로 돌아가기
            </Button>
