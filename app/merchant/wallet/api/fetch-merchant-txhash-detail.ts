...
export async function fetchMerchantTxDetail(txHash: string): Promise<BlockchainTransaction> {
    const res = await fetchWithAuth(`${API_URL}/api/merchants/wallet/tx/${txHash}`)
