    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <header className="bg-white">
        ...
        <div className="px-4 pb-4">
          <div className="gap-3">
            {/* 예금 → 토큰 버튼 - 높이 더 크게 조정 */}
            <div className="relative overflow-hidden bg-white border border-gray-200 rounded-xl h-16 flex items-center justify-center">
          ...
          <div className="bg-[#F5F5F5] px-4 py-5 rounded-xl">
            ...
            <div className="space-y-4">
              {[1,2,3].map((item, idx) => (
                <div
                  key={item}
                  className="bg-white border-none shadow-sm hover:bg-gray-50 transition-colors cursor-pointer rounded-xl"
                >
