  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F9FA] dark:bg-gray-900">
      <header className="p-4 flex items-center border-b border-gray-100 dark:border-gray-800">
        <div className="w-5 h-5 mr-2 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 h-12 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse" />
        </div>
      </div>
    </div>
  )
