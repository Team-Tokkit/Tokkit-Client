...
interface ConvertSkeletonProps {
  type: "deposit-to-token" | "token-to-deposit"
}

export default function ConvertSkeleton({ type }: ConvertSkeletonProps) {
        ...
        <div className="pb-32 max-w-sm mx-auto w-full">
              ...
              {isDepositToToken ? (
                <>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-base text-[#666666]">예금 잔액</span>
                    <div className="h-6 bg-gray-200 rounded w-24 animate-pulse"></div>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-base text-[#666666]">토큰 잔액</span>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between mt-2 w-full">
              <div></div>
              <Button variant="outline" size="sm" className="text-xs bg-white" disabled={true}>
                최대 금액
              </Button>
            </div>
          </div>
