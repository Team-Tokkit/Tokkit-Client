...
import { walletTerms as termsData } from "@/app/signup/wallet/terms/data/walletTerms"
...
export default function TermDetailPage() {
    ...
    useEffect(() => {
        ...
        if (foundTerm) {
            ...
            router.push("/signup/wallet/terms")
        }
    }, [termId, router])
    ...
    const handleAgree = () => {
        ...
        router.push(`/signup/wallet/terms?agreed=${updatedTerms.join(",")}`)
    }
