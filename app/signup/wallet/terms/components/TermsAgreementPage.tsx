...
import TermsModal from "@/app/signup/wallet/terms/components/TermModal"
import TermsCardList from "@/app/signup/wallet/terms/components/TermsCardList"
...
export default function TermsAgreementPage({ terms, redirectTo, title = "약관 동의", description = "안전한 서비스 이용을 위해 아래 약관에 동의해주세요." }: Props) {
