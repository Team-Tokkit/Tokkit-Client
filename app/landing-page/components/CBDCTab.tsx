...
import { CardInfo } from "@/app/landing-page/data/CardInfoData"
...
export default function CBDCTab({
                                    isOpen,
                                    onClose,
                                    currentCard,
                                    setCurrentCard,
                ...
                <div className="flex-1 relative flex items-center justify-center px-8">
                    ...
                    {currentCard > 0 && (
                        <Button
                            variant="ghost"
                            size="icon"
                            className="absolute left-0 -translate-x-1/2 top-1/2 -translate-y-1/2 z-30 bg-white/80 rounded-full h-10 w-10 shadow-md"
                    ...
                    {currentCard < cardInfo.length - 1 && (
                        <Button
                            variant="ghost"
                            size="icon"
                            className="absolute right-0 translate-x-1/2 top-1/2 -translate-y-1/2 z-30 bg-white/80 rounded-full h-10 w-10 shadow-md"
                            onClick={() => handleSwipe(1)}
                        >
