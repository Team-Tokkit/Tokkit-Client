    ...
    <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 animate-fadeIn">
          <div className="bg-white dark:bg-[#1A1A1A] p-6 rounded-2xl shadow-xl w-[320px] animate-scaleIn">
            ...
            <div className="flex items-center justify-center py-6">
              <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-full">
                <Trash2 className="h-10 w-10 text-red-500 dark:text-red-400" />
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setIsModalOpen(false)}
                className="flex-1 px-4 py-3 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-xl text-sm font-medium transition-colors"
              >
                취소
              </button>
              <button
          ...
          <div className="bg-white dark:bg-[#1A1A1A] p-6 rounded-2xl shadow-xl w-[320px] animate-scaleIn">
            {isDeleted ? (
              <div className="flex flex-col items-center py-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">바우처가 성공적으로 삭제되었습니다.</p>
              </div>
            ) : (
              <>
                <div className="flex items-center justify-between mb-4">
